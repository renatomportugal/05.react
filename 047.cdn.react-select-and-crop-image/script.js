function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}const { Component, PureComponent, createRef, Fragment } = React;
...
class CropImage extends PureComponent {constructor(...args) {super(...args);_defineProperty(this, "imageObject",
    new Image());_defineProperty(this, "getImagePortion",
    ...
    });}componentDidMount() {const { imageSrc } = this.props;this.imageObject.src = imageSrc;this.imageObject.setAttribute("crossOrigin", "anonymous");}

  render() {
    const { width, height, x, y } = this.props;

    return (
      React.createElement("div", { className: "crop-image-component-wrapper" },
      React.createElement("button", {
        className: "btn btn-danger",
        onClick: () =>
        this.getImagePortion(this.imageObject, width, height, x, y) }, "Crop")));
...
class SelectAndCrop extends PureComponent {constructor(...args) {super(...args);_defineProperty(this, "state",
    {
    ...
    });_defineProperty(this, "loadTimer", void 0);_defineProperty(this, "img",


    new Image());_defineProperty(this, "resizeMoveCropContainer",


    createRef());_defineProperty(this, "resizable",
    createRef());_defineProperty(this, "element", void 0);_defineProperty(this, "parentWidth", void 0);_defineProperty(this, "parentHeight", void 0);_defineProperty(this, "parentY", void 0);_defineProperty(this, "parentX", void 0);_defineProperty(this, "handleMouseMove",
...
class App extends Component {constructor(...args) {super(...args);_defineProperty(this, "state",
    {
      ...
      croppedImgSrc2: "",
      croppedImgSrc3: "",
      croppedImgSrc4: "" });_defineProperty(this, "form",


    createRef());_defineProperty(this, "onSelectImage",
  ...
  render() {
    ...
    return (
      ...
      React.createElement("h3", { className: "title" }, "Example with file input and user controls"),
      ...
      React.createElement("button", {
        ...
        onClick: this.removeImg }, "Remove image"),



      React.createElement(SelectAndCrop, {
        getCroppedImg: this.getCroppedImg,
      ...
      isError &&
      React.createElement("p", { className: "error-message" }, "Please select an image type of: (.png, .jpg, .jpeg)."),



      React.createElement("hr", null),
      React.createElement("h3", { className: "title" }, "Example with user controls"),
      React.createElement(SelectAndCrop, {
      ...
      React.createElement("hr", null),
      React.createElement("h3", { className: "title" }, "Example without user controls and with ratio (16:9)"),
      ...
      React.createElement("hr", null),
      React.createElement("h3", { className: "title" }, "Example without user controls and without ratio"),
