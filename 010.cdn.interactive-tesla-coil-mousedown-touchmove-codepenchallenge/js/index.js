...
const generateSegments = (startX, startY, number) => {
  const result = [];
  let refX = startX;
  let refY = startY;
...
const App = () => {
  ...
  return (
    ...
    React.createElement("div", { className: "tesla-coil__body" },
    React.createElement("div", { className: "tesla-coil__ring" }),
    React.createElement("div", { className: "tesla-coil__ring" }),
    React.createElement("div", { className: "tesla-coil__ring" }),
    React.createElement("div", { className: "tesla-coil__base" },
