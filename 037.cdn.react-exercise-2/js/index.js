...
class TeamList extends React.Component {
  render() {
    return (
      ...
      this.props.teams.map(teamObj => React.createElement(Team, { team: teamObj }))));
...
class Team extends React.Component {
  render() {
    return (
      React.createElement("div", null,
      React.createElement("h1", { style: { color: this.props.team.color } }, this.props.team.name),
      React.createElement("ul", null,
      this.props.team.players.map(
      playerObj => React.createElement(Player, { player: playerObj })))));
...
class Player extends React.Component {
  render() {
    return React.createElement("li", null, this.props.player);
  }}


ReactDOM.render(
React.createElement(TeamList, { teams: TEAMS }),
