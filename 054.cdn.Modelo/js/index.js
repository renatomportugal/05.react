const { React, ReactDOM, TweenMax, TimelineMax, Power1, Elastic } = window;
...
const App = () => {
  ...
  const burst = bursting => () => {
    ...
    ripple.current = new TimelineMax({
      onStart: () => {
        streams.current.classList[bursting ? 'add' : 'remove']('streams--bursting');
        quentin.current.classList[bursting ? 'add' : 'remove']('quentin--bursting');
      } }).
    ...
    to(streams.current, 0.4, { justifyContent: bursting ? 'center' : 'space-around' }).
    ...
    add(TweenMax.to(quentin.current, bursting ? 0.15 : 1, {
  ...
  return (
    ...
    React.createElement("div", { ref: streams, className: "streams" },
    new Array(6).fill().map((s, i) =>
    React.createElement("div", { className: "stream", key: `stream--${i}`, style: {
    ...
    React.createElement("div", { className: "quentin__wrapper" },
    React.createElement("svg", {
      ref: quentin,
      viewBox: "0 0 300 350",
      className: "quentin" },
    React.createElement("filter", { id: "ripple", filterUnits: "objectBoundingBox", x: "0", y: "0", width: "100%", height: "100%" },
    React.createElement("feTurbulence", { baseFrequency: "0.02 0.02", result: "turbulence", id: "ripple__turbulence", type: "fractalNoise", numOctaves: "1", seed: "1" }),
    React.createElement("feDisplacementMap", { id: "ripple__displacement", xChannelSelector: "R", yChannelSelector: "G", in: "SourceGraphic", in2: "turbulence", scale: "8" })),

    React.createElement("g", {
      transform: "translate(-21.49352,-703.36035)",
      filter: "url(#ripple)" },
    React.createElement("g", { transform: "translate(0,-46.473248)" },
