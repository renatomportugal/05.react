...
class App extends React.Component {
  ...
  render() {
    return (
      ...
      React.createElement("input", { type: "checkbox", checked: this.state.beRed,
        onChange: this.handleChecked.bind(this) }),
      React.createElement("input", { type: "text", value: this.state.text,
        onChange: this.handleText.bind(this) }),
      React.createElement("h1", { style: { color: this.state.beRed ? 'red' : 'black' } }, this.state.text)));
...
class TextBox extends React.Component {
  ...
  render() {
    return React.createElement("input", { type: "text", value: this.props.textVal });
  }}


// unit tests
// do not modify the below code
const tree = ReactDOM.render(React.createElement(App, null), document.getElementById('target'));
